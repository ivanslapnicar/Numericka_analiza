...
using PlutoUI, LinearAlgebra, Plots, Random
...
md"""
Dobiveni normirani vektori su vrijednosti skaliranih Legendreovih polinoma iz blježnice [NA12 Ortogonalni polinomi](https://ivanslapnicar.github.io/Numericka_analiza/NA12%20Ortogonalni%20polinomi.jl.html).

Da bi dobili Čebiševljeve polinome, trebamo dodati težinsku funkciju $\omega(x)=\displaystyle\frac{1}{\sqrt{1-x^2}}$ i preraditi funkciju `GramSchmidtQR()` iz bilježnice [NA15 QR rastav](https://ivanslapnicar.github.io/Numericka_analiza/NA15%20QR%20rastav.html) tako da računa __težinske skalarne produkte__. Dobiveni normirani vektori su vrijednosti skaliranih Čebiševljevih polinoma.
"""
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "8248e09f1a044c4ab93f3e72d5c1a8d872232028"
