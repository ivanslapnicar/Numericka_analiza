...
using PlutoUI, SymPyPythonCall, Polynomials, Plots
...
koristeći paket `SymPyPythonCall.jl` za simboličko računanje. 
"""
...
begin
	...
	for k=2:n
	    P[k]=x^(k-1)
	    for j=1:k-1
	       P[k]=P[k]-SymPyPythonCall.integrate(x^(k-1)*P[j]*ω(x),(x,a,b))* P[j]/SymPyPythonCall.integrate(P[j]*P[j]*ω(x),(x,a,b))
	    end
	end
end
...
manifest_format = "2.0"
project_hash = "0ce0172d038a58456095bd2b99e33cb05f0ce11c"
