...
using Images, LinearAlgebra, Plots, PlutoUI
...
scatter(1:length(diag(R.R,1)),abs.(diag(R.R)),
    title="Dijagonalni elementi matrice R",legend=false,ms=2)

# ╔═╡ d7fd21c0-25ae-11eb-217c-51b165642c9b
@bind k Slider(10:10:200,show_value=true,default=50)
...
manifest_format = "2.0"
project_hash = "971adb7bbcd61c69a92383ab112325acf42353aa"
